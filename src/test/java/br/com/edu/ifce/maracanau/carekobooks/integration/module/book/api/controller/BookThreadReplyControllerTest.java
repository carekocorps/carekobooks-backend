...
import br.com.edu.ifce.maracanau.carekobooks.factory.book.application.payload.query.BookThreadReplyQueryFactory;
...
class BookThreadReplyControllerTest {
    ...
    void search_withValidReplyQuery_shouldReturnPagedReplyResponse(String orderBy, boolean isAscendingOrder) {
        ...
        // Act
        var uri = BookThreadReplyQueryFactory.validURI(childReply, orderBy, isAscendingOrder);
        var response = restTemplate.exchange(uri.toString(), HttpMethod.GET, null, new ParameterizedTypeReference<ApplicationPage<BookThreadReplyResponse>>() {});
